# Health-AICare Project Instructions

## Project Overview

Health-AICare is a mental health AI platform for Indonesian university people (Health-AICare) implementing a **Safety Agent Suite** for proactive intervention. The system uses LangGraph-orchestrated agents with Google Gemini 2.5 API for CBT-informed therapeutic support.
