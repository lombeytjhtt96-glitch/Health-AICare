  ...
  return (
    <nav className="glass-card sticky top-0 z-50 px-6 py-4 flex items-center justify-between border-b border-dark-border">
      <Link href="/" className="flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-health-blue-dark to-health-blue flex items-center justify-center border border-health-gold/30 pulse-glow">
          <Shield className="w-6 h-6 text-health-gold" />
        </div>
        <div>
      ...
      <div className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-300">
        ...
        <Link href="/quests" className="hover:text-health-gold transition flex items-center gap-1.5">
          <Award className="w-4 h-4 text-amber-400" /> Quests
        </Link>
        <Link href="/admin/dashboard" className="hover:text-health-gold transition flex items-center gap-1.5">
          <Activity className="w-4 h-4 text-purple-400" /> Admin
        </Link>
        <Link href="/counselor/dashboard" className="hover:text-health-gold transition flex items-center gap-1.5">
