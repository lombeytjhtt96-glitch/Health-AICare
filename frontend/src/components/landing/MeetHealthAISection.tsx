...
const health_aiFeatures = [
  ...
  },
  {
    ...
    descriptionFallback: 'Exercises inspired by evidence-based approaches, designed for daily life.'
  }
];

export default function MeetHealthAISection() {
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-8">
              {health_aiFeatures.map((feature, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
