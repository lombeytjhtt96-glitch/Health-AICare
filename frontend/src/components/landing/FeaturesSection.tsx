...
const features = [
  ...
  },
  {
    ...
    titleFallback: 'Support pathways',
    descriptionKey: 'landing.features.f3.desc',
    descriptionFallback: "Guidance toward local services, and help preparing what to share.",
  ...
  },
  {
    ...
    descriptionFallback: 'Coping tools, self-help guides, and community resources in one place.',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <p className="text-gray-400 mb-4">
            {t('landing.features.footer', 'And more features designed with daily life in mind.')}
          </p>
          <motion.a
            href="/about"
