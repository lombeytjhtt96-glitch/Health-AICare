    ...
    variants: {
      variant: {
        ...
        destructive: 'bg-red-500 text-destructive-foreground hover:bg-red-500/90',
         ...
         outline: 'border border-white/20 bg-white/10 text-health-gold hover:bg-white/20 backdrop-blur-sm',
        // Secondary/Subtle variant (example)
        secondary: 'bg-health-blue-light/20 text-health-blue-dark hover:bg-health-blue-light/30',
        // Ghost variant (example)
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        // Link variant (example)
        link: 'text-primary underline-offset-4 hover:underline',
        // Add the specific gold/blue variant for Send button
         primaryGold: 'bg-health-gold text-health-blue-dark hover:bg-health-gold/90 disabled:bg-health-gold/50',
      },
      size: {
