        ...
        <div className="flex items-end gap-2 sm:gap-3 rounded-full border border-white/20 bg-white/10 px-3 sm:px-4 py-2 sm:py-3 shadow-lg backdrop-blur-xl transition-all duration-300">
          ...
          <button
            ...
            className={cn(
              ...
              showModules 
                ? "bg-health-gold/20 text-health-gold" 
            ...
            <button
              ...
              className={cn(
                ...
                actionIsCancel
                  ...
                  : "bg-health-gold text-health-blue hover:bg-health-gold/90"
              )}
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <BrainCircuit className="h-5 w-5 sm:h-6 sm:w-6 text-health-gold" />
              ...
              <div className="grid gap-3 sm:grid-cols-2">
                {availableModules.map((mod) => (
                  <button
                    ...
                    disabled={isLoading}
                    className="group flex w-full flex-col rounded-xl border border-white/15 bg-white/5 px-3 sm:px-4 py-3 sm:py-3.5 text-left transition hover:border-health-gold/50 hover:bg-white/10 disabled:opacity-50"
                  >
                    <span className="text-sm sm:text-base font-semibold text-white group-hover:text-health-gold">{mod.name}</span>
