    ...
    <div className={cn("relative inline-block w-full text-left sm:w-auto", className)}>
      ...
      <button
        ...
        className={cn(
          ...
          "hover:bg-white/20 transition-colors focus:outline-none focus:ring-2 focus:ring-health-gold/50"
        )}
      >
              ...
              {options.map((option) => (
                <li key={option.value}>
                  ...
                  >
                    ...
                    {model === option.value && <Check className="w-4 h-4 text-health-gold" />}
                  </button>
                </li>
              ))}
            </ul>
