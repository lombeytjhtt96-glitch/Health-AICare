          ...
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-3 flex-1">
              <div className="p-3 bg-linear-to-br from-health-gold to-health-gold-light rounded-2xl shadow-xl shrink-0">
                <Sparkles className="w-6 h-6 text-health-blue" />
              </div>
              <div className="flex-1">
                <h4 className="text-base font-bold text-white flex items-center gap-2 flex-wrap">
                  Rencana Dukungan untuk Kamu
                  <span className="text-xs font-semibold text-health-gold bg-health-gold/20 px-3 py-1 rounded-full border border-health-gold/40">
          ...
          {totalSteps > 0 && (
            <div className="mt-5 space-y-2">
              <div className="flex items-center justify-between text-sm">
                ...
                <span className="text-health-gold font-bold">{Math.round(progressPercent)}%</span>
              </div>
              <div className="h-3 bg-white/15 rounded-full overflow-hidden backdrop-blur-sm border border-white/20">
                <motion.div
                  className="h-full bg-linear-to-r from-health-gold via-health-gold-light to-health-gold rounded-full shadow-lg relative overflow-hidden"
                  initial={{ width: 0 }}
          ...
          >
            ...
            {plan.plan_steps.length > 0 && (
              <div className="p-5 space-y-3">
                <h5 className="text-sm font-bold text-health-blue flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 rounded-lg bg-health-blue/10 flex items-center justify-center">
                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        isCompleted
                          ...
                          : 'bg-white border-gray-200 hover:border-health-blue/50 hover:shadow-md'
                      )}
                    ...
                    >
                      <div className="shrink-0 mt-0.5 transition-transform group-hover:scale-110">
                        {isCompleted ? (
                          ...
                          <div className="w-6 h-6 rounded-full border-2 border-health-blue/40 flex items-center justify-center text-xs font-bold text-health-blue bg-white shadow-sm group-hover:border-health-blue group-hover:bg-health-blue/5">
                            {index + 1}
                          </div>
                        )}
                      </div>
            ...
            {plan.resource_cards.length > 0 && (
              <div className="px-5 pb-5 space-y-3">
                <h5 className="text-sm font-bold text-health-blue flex items-center gap-2 mb-1">
                  <div className="w-7 h-7 rounded-lg bg-health-blue/10 flex items-center justify-center">
                    <BookOpen className="w-4 h-4 text-health-gold" />
                  </div>
                  ...
                  return (
                    <motion.a
                      ...
                      className={cn(
                        ...
                        card.url
                          ? 'bg-white border-purple-200/80 hover:border-health-gold/60 hover:shadow-lg cursor-pointer group'
                          : 'bg-gray-50 border-gray-200 cursor-default'
                      )}
                    >
                      <div className="flex items-start gap-3">
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-semibold text-health-blue-dark group-hover:text-health-blue transition-colors">
                            {card.title}
                          </p>
                        ...
                        {card.url && (
                          <ExternalLink className="w-4 h-4 text-health-blue shrink-0 mt-0.5 group-hover:text-health-gold transition-colors" />
                        )}
                      </div>
                    </motion.a>
                  );
            ...
            {plan.next_check_in && (
              <div className="px-5 pb-5">
                <div className="p-4 bg-linear-to-br from-blue-50 to-purple-50 border-2 border-blue-200/60 rounded-xl shadow-sm">
                  <p className="text-sm text-health-blue-dark leading-relaxed">
