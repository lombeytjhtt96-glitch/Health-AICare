        ...
        >
          ...
          >
            ...
            <div className="flex items-start justify-between gap-4 border-b border-white/10 bg-white/5 px-5 py-4 md:px-6">
              ...
              <button
                onClick={onClose}
                className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-white/10 text-white/70 transition hover:bg-white/20 hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-health-gold/60"
              ...
              <div className="space-y-5">
                  ...
                  <div className="rounded-xl border border-white/15 bg-white/5 p-5 backdrop-blur-sm">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="w-full appearance-none rounded-xl border border-white/20 bg-white/10 px-4 py-3 pr-10 text-sm text-white focus:border-health-gold/50 focus:outline-none focus:ring-2 focus:ring-health-gold/30"
                      >
                ...
                <div className="rounded-xl border border-white/15 bg-white/5 p-5 backdrop-blur-sm">
                  ...
                  <label className="flex cursor-pointer items-start gap-3 rounded-lg border border-white/10 bg-white/5 p-4 transition hover:border-health-gold/40 hover:bg-white/8">
                    <input
                      type="checkbox"
                      className="mt-1 h-4 w-4 shrink-0 accent-health-gold"
                ...
                <div className="rounded-xl border border-white/15 bg-white/5 p-5 backdrop-blur-sm">
                  ...
                  <div className="space-y-3">
                    <label className="flex cursor-pointer items-center gap-3 rounded-lg border border-white/10 bg-white/5 p-4 transition hover:border-health-gold/40 hover:bg-white/8">
                      <input
                        type="checkbox"
                        className="h-4 w-4 shrink-0 accent-health-gold"
                        checked={messageSoundsEnabled}
                        onChange={(event) => setMessageSoundsEnabled(event.target.checked)}
                      />
                      <FiVolume2 className="h-5 w-5 shrink-0 text-health-gold" />
                      <div className="flex-1">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                      <div className="mb-3 flex items-center gap-2">
                        <FiMic className="h-5 w-5 text-health-gold" />
                      ...
                      <Button
                        ...
                        className="w-full border-white/20 bg-health-gold/10 text-health-gold transition hover:bg-health-gold/20 disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-health-gold/50"
                      >
                        {isRecording ? (
                          <>
                    ...
                    <div className="rounded-lg border border-white/10 bg-white/5 p-4">
                      <div className="mb-3 flex items-center gap-2">
                        <FiVolume2 className="h-5 w-5 text-health-gold" />
                      ...
                      >
                        {isTesting ? (
                          <>
                            <span className="inline-block h-2 w-2 animate-pulse rounded-full bg-health-gold mr-2" />
                            Memutar...
                          </>
                        ) : (
                          <>
            ...
            <div className="border-t border-white/10 bg-white/5 px-5 py-4 md:px-6">
              <div className="flex justify-end">
                <Button
                  onClick={onClose}
                  className="w-full bg-health-gold text-health-blue hover:bg-health-gold/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-health-gold/50 sm:w-auto"
                >
                  Selesai
                </Button>
              </div>
