          ...
          >
            <div className="flex flex-col gap-6 p-6 md:gap-8 md:p-8">
              <div className="flex flex-col gap-2 md:flex-row md:items-center md:justify-between">
                ...
                <button
                  onClick={onClose}
                  className="self-start rounded-full p-1 text-gray-300 transition-colors hover:text-white focus-visible:outline-2 focus-visible:outline-health-gold/60"
              ...
              <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr]">
                <div className="flex flex-col gap-4">
                  <div className="grid gap-3 sm:grid-cols-2">
                    <label className="group flex items-start gap-3 rounded-2xl border border-white/12 bg-white/8 p-4 transition hover:border-health-gold/40">
                      <input
                        type="checkbox"
                        className="mt-1.5 h-4 w-4 flex-none accent-health-gold"
              ...
              {!envData ? (
                <div className="flex flex-col gap-4">
                  ...
                  <input
                    ...
                    className="rounded-lg border border-white/20 bg-white/10 px-4 py-2 text-white placeholder-white/40 focus:border-health-gold/60 focus:outline-none"
                    onKeyPress={(e) => {
                      if (e.key === 'Enter') {
                  ...
                  <Button
                    ...
                    disabled={loadingEnv}
                    className="bg-health-gold text-health-blue-dark hover:bg-health-gold/90"
                  >
