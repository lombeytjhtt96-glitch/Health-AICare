...
export function AppointmentCard({ appointment, onCancel, onReschedule }: AppointmentCardProps) {
  ...
  return (
    <motion.div
      ...
      className="mt-4 bg-white/95 backdrop-blur-xl border-2 border-health-blue/20 rounded-2xl overflow-hidden shadow-2xl hover:shadow-health-blue/20"
    >
      {/* Enhanced Header with Gradient */}
      <div className="bg-linear-to-br from-health-blue via-health-blue to-health-blue-light p-5 relative overflow-hidden">
        {/* Decorative elements */}
        <div className="absolute top-0 right-0 w-32 h-32 bg-health-gold/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-8 -left-8 w-24 h-24 bg-white/5 rounded-full blur-2xl" />
        
        <div className="relative z-10">
          <div className="flex items-start justify-between gap-3">
            <div className="flex items-start gap-3 flex-1">
              <div className="p-3 bg-linear-to-br from-health-gold to-health-gold-light rounded-2xl shadow-xl shrink-0">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex items-start gap-4">
          <div className="p-3 bg-health-blue/5 rounded-xl">
          ...
          <div className="flex-1">
            ...
            <div className="flex items-center gap-2 mt-1">
              <Clock className="w-4 h-4 text-health-gold" />
              <p className="text-base font-semibold text-health-blue">{formattedTime} WIB</p>
            </div>
          </div>
        </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              ...
              {appointment.psychologist.specialization && appointment.psychologist.specialization.length > 0 && (
                <div className="flex items-center gap-2 mt-1">
                  <Briefcase className="w-4 h-4 text-health-gold" />
              ...
              {appointment.psychologist.languages && appointment.psychologist.languages.length > 0 && (
                <div className="flex items-center gap-2 mt-1">
                  <Languages className="w-4 h-4 text-health-gold" />
                  <p className="text-sm text-gray-600">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-base font-bold text-gray-900">
              {appointment.location || 'Klinik Layanan Konseling, Lantai 2'}
            </p>
        ...
        {appointment.appointment_type && (
          <div className="flex items-start gap-4">
            <div className="p-3 bg-health-blue/5 rounded-xl">
              <Briefcase className="w-5 h-5 text-health-blue" />
            </div>
            <div className="flex-1">
        ...
        {/* Notes */}
        {appointment.notes && (
          <div className="bg-health-gold/5 border border-health-gold/20 rounded-xl p-4">
            <p className="text-sm font-semibold text-health-blue mb-2">Catatan:</p>
        ...
        {appointment.status === 'scheduled' && (
          <div className="flex gap-3 pt-4 border-t border-gray-100">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-health-blue hover:bg-health-blue-dark text-white font-semibold rounded-xl transition-all hover:shadow-lg hover:scale-[1.02] active:scale-[0.98]"
            >
        ...
        <div className="bg-health-blue/5 border border-health-blue/20 rounded-xl p-4 mt-4">
          <p className="text-xs font-semibold text-health-blue mb-2">📞 Kontak Darurat</p>
          <div className="space-y-1">
            <p className="text-xs text-gray-600 flex items-center gap-2">
              <Phone className="w-3 h-3" />
              Layanan Pendampingan Krisis: <span className="font-semibold">0274-544571</span>
            </p>
            <p className="text-xs text-gray-600 flex items-center gap-2">
              <Phone className="w-3 h-3" />
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-health-blue focus:ring-2 focus:ring-health-blue/20 outline-none transition-all resize-none"
                  rows={3}
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="p-3 bg-health-blue/10 rounded-xl">
                <Edit3 className="w-6 h-6 text-health-blue" />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-gray-200 rounded-xl focus:border-health-blue focus:ring-2 focus:ring-health-blue/20 outline-none transition-all"
                  disabled={isProcessing}
              ...
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 px-4 py-3 bg-health-blue hover:bg-health-blue-dark text-white font-semibold rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
