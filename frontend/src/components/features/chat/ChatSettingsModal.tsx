          ...
          >
            <div className="flex items-start justify-between gap-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="text-white/60 hover:text-white rounded-full p-1 focus-visible:outline focus-visible:outline-health-gold/60"
                aria-label="Tutup"
              >
                <FiX size={18} />
              </button>
            ...
            <div className="mt-5 space-y-5 text-sm text-white/80">
              <label className="flex items-start gap-3">
                <input
                  type="checkbox"
                  className="mt-0.5 h-4 w-4 accent-health-gold"
