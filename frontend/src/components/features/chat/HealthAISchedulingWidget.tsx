  ...
  return (
    <div className="mt-3 rounded-2xl border border-white/15 bg-white/5 p-4 text-white/90 backdrop-blur-sm">
      <div className="mb-3 flex items-center gap-2">
        <CalendarDays className="h-4 w-4 text-health-gold" />
      ...
      <div className="mb-3 flex items-center gap-2 text-[11px] text-white/70">
        <span className={step >= 1 ? 'text-health-gold' : ''}>1. Counselor</span>
        <ChevronRight className="h-3 w-3" />
        <span className={step >= 2 ? 'text-health-gold' : ''}>2. Tipe</span>
        <ChevronRight className="h-3 w-3" />
        <span className={step >= 3 ? 'text-health-gold' : ''}>3. Waktu</span>
      </div>
          ...
          {step === 1 && (
            <div className="space-y-3">
              ...
              <select
                ...
                className="w-full rounded-xl border border-white/15 bg-black/20 px-3 py-2 text-sm text-white outline-none focus:border-health-gold"
              >
                {counselors.map((item) => (
              ...
              <button
                ...
                className="w-full rounded-xl bg-health-gold px-3 py-2 text-sm font-semibold text-health-blue disabled:opacity-50"
              >
            ...
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <button
                  ...
                  className="rounded-xl bg-health-gold px-3 py-2 text-xs font-semibold text-health-blue disabled:opacity-50"
                >
                  Lanjut ke waktu
                </button>
              </div>
