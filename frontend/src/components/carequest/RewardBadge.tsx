...
const rarityConfig = {
  ...
  legendary: {
    gradient: 'from-health-gold via-yellow-400 to-health-gold',
    glow: 'shadow-health-gold/60',
    border: 'border-health-gold',
    text: 'text-health-gold',
  },
};
    ...
    >
      ...
      <div
        className={cn(
          ...
          'bg-gradient-to-br from-health-blue/40 to-health-blue-dark/60',
          sizes.container,
      ...
      >
        ...
        {earned && rarity === 'legendary' && (
          <motion.div
            className="absolute inset-0 rounded-2xl bg-gradient-to-r from-health-gold/20 via-transparent to-health-gold/20"
            animate={{ rotate: 360 }}
      ...
      >
        <div className="bg-health-blue-dark/95 backdrop-blur-md rounded-lg p-3 shadow-xl border border-white/20 min-w-[200px]">
