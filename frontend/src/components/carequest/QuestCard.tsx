...
const difficultyConfig = {
  ...
  legendary: {
    ...
    bg: 'bg-health-gold/20',
    border: 'border-health-gold/50',
    glow: 'shadow-health-gold/30',
  },
};
  ...
  return (
    ...
    >
      ...
      {completed && (
        ...
        >
          <CheckCircle className="w-8 h-8 text-health-gold" strokeWidth={2.5} />
        </motion.div>
      )}
      ...
      <div className="relative p-6 space-y-4">
        {/* Category tag */}
        {category && (
          <div className="inline-block px-2 py-1 bg-white/10 rounded text-xs text-health-gold font-medium">
            {category}
          </div>
        )}
        ...
        <div className="flex items-center justify-between pt-2 border-t border-white/10">
          <div className="flex items-center gap-2 text-health-gold">
