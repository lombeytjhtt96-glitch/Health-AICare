      ...
      <AnimatePresence>
        {isSidebarOpen && ( // Only render if sidebar is open
          <motion.button
            ...
            className="fixed bottom-6 right-6 z-50 bg-health-gold text-health-blue-dark px-5 py-3 rounded-full shadow-lg hover:bg-opacity-90 transition-all font-semibold flex items-center space-x-2"
