...
// ── Case scenario data — mirrors the exact routing in health_ai_orchestrator_graph.py
                                ...
                                {[
                                    {
                                        ...
                                        items: ['User Profile & Screening History', 'Current Conversation Context', 'Clinical Guidelines (JUKNIS)'],
                                    },
                                    {
                        ...
                        >
                            <div className="space-y-8">
                                ...
                                <div className="space-y-4">
                                    {[
                                        { tag: 'HealthAIOrchestratorState', color: 'blue',   title: 'The Environment',  body: 'TypedDict holding shared state (Beliefs) visible to all nodes — risk level, intent, agent outputs, screening profile.' },
                            ...
                            <div className="bg-black/30 rounded-2xl p-8 border border-white/5 font-mono text-sm text-white/70 overflow-auto relative">
                                <div className="absolute top-4 right-4 text-xs text-white/20 font-bold uppercase tracking-widest">health_ai_orchestrator_graph.py</div>
                                <pre className="whitespace-pre-wrap relative z-10 text-xs leading-relaxed">
{`# HealthAIOrchestratorState (LangGraph TypedDict)
class HealthAIOrchestratorState(TypedDict):
    message: str
...
# fired inside health_ai_decision_node on conversation_ended=True`}
                                </pre>
                            </div>
                        </motion.div>
                    )}
