...
export function ExecutionHistoryTable({ limit = 50 }: ExecutionHistoryTableProps) {
  ...
  useEffect(() => {
    ...
    const validGraph = graphFilter as 'sta' | 'tca' | 'cma' | 'ia' | 'health_ai' | 'orchestrator' | '';
    fetchHistory({
      limit,
      offset,
      status: validStatus || undefined,
      graph_name: (validGraph || undefined) as 'sta' | 'tca' | 'cma' | 'ia' | 'health_ai' | 'orchestrator' | undefined
    });
      ...
      <div className="flex justify-between items-center p-3 border-b border-white/20 bg-white/5">
        ...
        <div className="flex gap-2 text-xs">
          ...
          >
            ...
            <option value="health_ai">HEALTH_AI</option>
          </select>
          <button
