        ...
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-red-500 mt-1">{screeningDashboard?.profiles_requiring_attention || 0}</p>
            </div>
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-green-400 mt-1">{stats?.active_users_7d || 0}</p>
            </div>
