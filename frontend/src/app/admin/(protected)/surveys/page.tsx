              ...
              <div className="flex items-start justify-between gap-3">
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <h2 className="text-sm font-semibold text-white break-words" title={survey.title}>{survey.title}</h2>
                  </div>
                  {survey.description && (
          ...
          >
            ...
            >
              <div className="px-6 py-4 border-b border-white/20">
                <h2 id="create-survey-title" className="text-lg font-medium text-white">Create New Survey</h2>
              </div>
              <div className="p-6 space-y-4">
                ...
                <div>
                  <h3 className="text-md font-medium text-white mb-2">Questions</h3>
                  <QuestionListEditor
      ...
      <AnimatePresence>
        {isEditModalOpen && selectedSurvey && (
          ...
          >
            ...
            >
              <div className="px-6 py-4 border-b border-white/20">
                <h2 id="edit-survey-title" className="text-lg font-medium text-white">Edit Survey</h2>
              </div>
              <div className="p-6 space-y-4">
                <div className="space-y-1">
      ...
      <AnimatePresence>
        {isResultsModalOpen && (
          ...
          >
            ...
            >
              <div className="px-6 py-4 border-b border-white/20">
                <h2 id="results-survey-title" className="text-lg font-medium text-white">Survey Results</h2>
              </div>
              <div className="p-6">
