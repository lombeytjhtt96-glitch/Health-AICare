 ...
 * - Medieval/fantasy aesthetic with theme colors
 */
          ...
          >
              ...
              <div className="bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 p-8 shadow-2xl">
                ...
                <div className="bg-[#001D58]/50 rounded-xl p-6 h-[500px] overflow-y-auto mb-4 border border-white/10">
                  ...
                  <div className="text-center mt-12">
                    <div className="inline-block px-6 py-3 bg-health-gold/20 border border-health-gold/50 rounded-xl">
                      <p className="text-health-gold font-semibold">🚧 Real-time chat coming soon!</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex gap-3">
                  <input
                    ...
                    className="flex-1 px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-health-gold disabled:opacity-50"
                    disabled
                  ...
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
                    className="px-8 py-3 bg-gradient-to-r from-health-gold to-yellow-500 text-health-blue-dark font-bold rounded-xl shadow-lg disabled:opacity-50"
                    disabled
                  >
                    Send
                  </motion.button>
            ...
            {activeTab === 'settings' && (
              <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-2xl border-2 border-white/20 p-8 shadow-2xl">
                <div className="flex items-center gap-3 mb-6">
                  <Settings className="w-8 h-8 text-health-gold" />
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-health-gold disabled:opacity-50"
                      disabled
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      defaultValue="A supportive community for users practicing mental wellness together. We believe in the power of collective healing and mutual support."
                      className="w-full px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-health-gold disabled:opacity-50"
                      disabled
                  ...
                  <div>
                    ...
                    <select
                      id="guild-privacy"
                      className="w-full px-6 py-3 bg-white/10 backdrop-blur-sm border border-white/20 rounded-xl text-white focus:outline-none focus:ring-2 focus:ring-health-gold disabled:opacity-50"
                      disabled
                  ...
                  <div className="flex gap-4 pt-4">
                    <motion.button
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      className="flex-1 px-8 py-3 bg-gradient-to-r from-health-gold to-yellow-500 text-health-blue-dark font-bold rounded-xl shadow-lg disabled:opacity-50"
                      disabled
                    >
                      Save Changes
                    </motion.button>
