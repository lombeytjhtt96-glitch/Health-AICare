  ...
  const mockItems: MarketItem[] = [
    {
      id: '1',
      name: 'Cafe Voucher',
      description: 'Redeem Rp 25.000 at selected local cafes. Enjoy your favorite coffee!',
      price: 50,
      category: 'voucher',
      rarity: 'common',
      icon: '☕',
    ...
    },
    {
      ...
      description: 'Rp 50.000 voucher for bookstore. Get books and stationery.',
      price: 100,
      category: 'voucher',
      rarity: 'rare',
      icon: '📚',
        ...
        >
          <div className="flex items-center justify-between flex-wrap gap-6">
            ...
            <div className="flex gap-8">
              ...
              <div className="text-center">
                <div className="text-3xl font-bold text-health-gold mb-1">12</div>
              ...
              return (
                <motion.button
                  ...
                  className={`
                    ...
                    ${isActive
                      ? 'bg-gradient-to-r from-health-gold to-yellow-500 text-health-blue-dark shadow-lg shadow-health-gold/50'
            ...
            return (
              ...
              >
                ...
                {item.rarity === 'legendary' && (
                  <motion.div
                    className="absolute inset-0 bg-gradient-to-r from-health-gold/10 via-transparent to-health-gold/10"
                    animate={{ rotate: 360 }}
                ...
                {/* Item card content */}
                <div className={`relative bg-gradient-to-br from-health-blue/80 to-health-blue-dark/80 p-6`}>
                  {/* Rarity badge */}
