            ...
            <div className="text-left space-y-6">
              ...
              <div className="relative">
                ...
                <p className="text-base md:text-lg text-gray-300">
                  🏛️ Embark on therapeutic quests in your daily life
                </p>
              </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            ...
            {[
              {
                title: 'Quest Map',
                description: 'Explore our interactive map and complete therapeutic quests',
                icon: Map,
                href: '/carequest/game',
              ...
              >
                <Link href={item.href}>
                  <motion.div
                    ...
                    whileTap={{ scale: 0.98 }}
                    className={`relative overflow-hidden rounded-xl border-2 border-white/30 bg-gradient-to-br from-health-blue/80 to-health-blue-dark/80 backdrop-blur-sm p-6 cursor-pointer ${item.glow} shadow-xl hover:shadow-2xl transition-shadow group`}
                  >
                    {/* Shimmer effect */}
                    <motion.div
                    ...
                    <div className="relative z-10">
                      ...
                      <h3 className="text-xl font-bold text-white mb-2 group-hover:text-health-gold transition-colors">
                        {item.title}
                      </h3>
                      ...
                      <motion.div
                        className="mt-4 flex items-center gap-2 text-xs font-semibold text-health-gold opacity-0 group-hover:opacity-100 transition-opacity"
                        initial={{ x: -10 }}
                        whileHover={{ x: 0 }}
                      >
                        <span>ENTER</span>
      ...
      <section className="container mx-auto px-6 mb-16 relative z-10">
        ...
        >
          <h2 className="text-4xl font-bold text-white text-center mb-4">
            Featured <span className="text-health-gold">Quests</span>
          </h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {[
              ...
              },
              {
                ...
                rarity: 'Legendary',
                color: 'from-health-gold to-yellow-400',
                unlocked: false,
              },
              {
                tokenId: 7,
              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-health-blue/90 to-health-blue-dark/90 backdrop-blur-sm rounded-2xl border-2 border-white/20 overflow-hidden shadow-xl group-hover:shadow-2xl group-hover:border-white/40 transition-all">
                  ...
                  {/* Badge Info */}
                  <div className="p-4">
                    <h3 className="text-lg font-bold text-white mb-1 group-hover:text-health-gold transition-colors">
                      {badge.title}
                    </h3>
          ...
          >
            <Link href="/carequest/activities">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative px-8 py-4 bg-gradient-to-r from-health-gold to-yellow-400 text-health-blue-dark font-bold rounded-xl shadow-lg hover:shadow-2xl hover:shadow-health-gold/50 transition-all overflow-hidden"
              >
                <motion.div
        ...
        >
          <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-md rounded-2xl border-2 border-white/20 p-8 shadow-2xl">
            <h2 className="text-4xl font-bold text-white text-center mb-8">
              How <span className="text-health-gold">CareQuest</span> Works
            </h2>
            ...
            <div className="grid md:grid-cols-3 gap-6 mb-8">
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 rounded-full bg-gradient-to-br from-health-gold to-yellow-600 flex items-center justify-center text-2xl font-bold text-white">
                  3
                </div>
            ...
            <div className="bg-aurora-blue/10 border border-aurora-blue/30 rounded-xl p-6">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                users are more likely to build consistent habits that improve wellbeing.
              </p>
            </div>
          </div>
        </motion.div>
      ...
      <section className="container mx-auto px-6 py-16 relative z-10">
        ...
        >
          <h2 className="text-5xl font-bold text-white mb-4">
            Ready to Begin Your <span className="text-health-gold">Adventure</span>?
          </h2>
          ...
          <Link href="/carequest/game">
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="inline-block px-16 py-6 bg-gradient-to-r from-health-gold to-yellow-500 text-health-blue-dark text-2xl font-black rounded-xl shadow-2xl shadow-health-gold/50"
            >
              <span className="flex items-center gap-3">
