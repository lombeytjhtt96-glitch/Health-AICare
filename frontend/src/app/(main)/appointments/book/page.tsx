    ...
    <div className="min-h-screen bg-gradient-to-b from-[#001D58] to-[#00308F] pt-24 pb-10 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto">
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <ul className="list-disc list-inside text-sm text-gray-300 space-y-1 mt-2">
                      ...
                      <li>Bring a valid identity card</li>
                      <li>Cancellation requires 24-hour notice</li>
                      <li>For emergencies, please call the Crisis Line at (0274) 123-4567</li>
                    </ul>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-8 text-center text-gray-400 text-sm">
          <p>Need assistance? Contact the support team at <a href="tel:+62274123456" className="text-[#FFCA40] hover:underline">+62 274 123456</a></p>
        </div>
      </div>
    </div>
  );
