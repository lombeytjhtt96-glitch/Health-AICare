        ...
        <div className="space-y-6 px-6 py-6">
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed text-white/70">
              Every consequential action that Health-AI takes — creating an escalation case, minting a
            ...
            <ul className="mt-3 space-y-2 text-sm text-white/60">
              <li className="flex items-start gap-2">
                ...
                <span><span className="text-white/80">Queued</span> — Health-AI decides an action is warranted and submits it.</span>
              </li>
              <li className="flex items-start gap-2">
            ...
            <p className="mt-3 text-sm text-white/50">
              The timeline is your personal audit log. It shows what Health-AI did, why it was allowed,
          ...
          <section>
            ...
            <p className="mt-3 text-sm text-white/50">
              ...
              vulnerable users: accountability. The attestation ledger makes Health-AI&apos;s decisions
          ...
          <section>
            ...
            <p className="text-sm leading-relaxed text-white/70">
              ...
              <span className="font-mono text-xs text-white/80"> HealthAIJournalBadges.sol</span>.
            ...
            <div className="mt-4 grid grid-cols-1 gap-2 sm:grid-cols-2">
              {[
                ...
                { category: "Engagement", items: ["First Health-AI session", "Extended chat session (20+ messages)"] },
            ...
            <div className="mt-4 rounded-xl border border-[#FFCA40]/20 bg-[#FFCA40]/5 px-4 py-3">
              <p className="text-xs font-medium text-[#FFCA40]">HealthAIJournalBadges.sol (ERC1155)</p>
              <CopyableAddress
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-md text-sm leading-relaxed text-white/60">
              Every consequential action Health-AI takes is recorded here as it moves through the
        ...
        {loading ? (
          ...
          <div className="rounded-2xl border border-white/10 bg-white/5 py-16 text-center">
            ...
            <p className="text-sm text-white/50">
              {filter === "all"
                ? "No autopilot actions yet. Health-AI will record actions here as she works."
                : `No ${filter} actions.`}
            </p>
          </div>
        ) : (
