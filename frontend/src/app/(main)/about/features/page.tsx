      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="space-y-6">
            {[
              {
                title: "Verified Counselor Directory",
                description: "Browse verified mental health professionals, view their specializations, availability, and ratings from other users.",
                icon: <FiUsers />
              },
              {
              ...
              },
              {
                ...
                description: "Schedule in-person or virtual appointments with verified counselors directly through the platform. Automated reminders included.",
                icon: <FiCalendar />
              }
            ].map((resource, idx) => (
              <motion.div
