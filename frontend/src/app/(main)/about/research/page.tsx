            ...
            {[
              {
                ...
                description: "Reactive mental health services, under-resourced staff, limited data visibility.",
                color: "#FF6B9D"
              },
              {
                stage: "2",
              ...
              },
              {
                stage: "4",
                title: "Demonstration",
                description: "Pilot deployment with active users, A/B testing of intervention strategies, usability studies.",
                color: "#50E3C2"
              },
              {
                stage: "5",
