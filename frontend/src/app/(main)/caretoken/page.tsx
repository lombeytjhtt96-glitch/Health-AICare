  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#001D58] via-[#00308F] to-[#002A7A]">
      ...
      >
        ...
        >
          The utility token powering Health-AICare on SOMNIA blockchain. 
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-white/70 text-sm">Health-AICare manages staking operations as the Mudarib (entrepreneur)</p>
                </div>
              </div>
  ...
  const content = {
    ...
    spend: {
      ...
      items: [
        ...
        { icon: <FaShoppingCart />, title: "Official Merchandise", price: "500-2,000 CARE", description: "Official merch and mental health resources" },
    ...
    govern: {
      ...
      description: "Shape the future of Health-AICare platform",
      items: [
  ...
  const faqs = [
    {
      ...
      a: "$CARE is a utility token built on SOMNIA blockchain that powers the Health-AICare mental health platform. It rewards users for wellness activities and can be used for real-world goods and services."
    },
    {
    ...
    },
    {
      ...
      a: "Use CARE for food vouchers (Grab/GoFood), event tickets, premium AI coaching, counseling sessions, official merchandise, and transportation. Prices range from 100-2,000 CARE depending on the item."
    },
    {
