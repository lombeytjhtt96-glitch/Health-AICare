...
The **blockchain/** module consolidates all smart contract interactions for the Health-AICare Support platform across **multiple blockchains**, providing a clean separation of concerns from business logic.

## 🌐 Multi-Chain Architecture

Health-AICare Support integrates with **two blockchains**:
...
**Purpose**: Achievement NFT badges for user accomplishments

**Contracts**:

- **Health-AICareJournalBadges** (ERC1155) - Multi-token NFT for various achievement types

**Use Cases**:

- Mint NFT badges when people complete quests, journals, or milestones
...
│   └── abi/
│       └── Health-AICareJournalBadges.json
│
...
The NFT badge system rewards people for completing mental health milestones on EDU Chain Testnet (L3 on Arbitrum Orbit).
...
```env
EDU_TESTNET_RPC_URL=https://rpc.open-life-codex.gelato.digital
NFT_CONTRACT_ADDRESS=0x...  # Health-AICareJournalBadges contract
