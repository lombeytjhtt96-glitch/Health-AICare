...
Handles Health-AICareJournalBadges ERC1155 contract for achievement NFTs on EDU Chain Testnet.

Contract: Health-AICareJournalBadges.sol (ERC1155)
Network: EDU Chain Testnet
RPC: https://rpc.open-life-codex.gelato.digital
"""
...
abi_path = os.path.join(os.path.dirname(__file__), 'abi', 'Health-AICareJournalBadges.json')
