...
# =============================================================================
# Work and Daily Stress (Occupational-Specific)
# Adapted for general work/daily task context
# =============================================================================
ACADEMIC_STRESS_DOMAINS: List[InstrumentDomain] = [
    InstrumentDomain(
        name="academic_pressure",
        description="Pressure from work and daily demands",
        keywords_en=["too much work", "deadlines", "tasks", "projects", "overwhelmed by tasks"],
        keywords_id=["terlalu banyak tugas", "deadline", "kerjaan", "kewalahan kerja"],
        weight=1.0,
    ),
    InstrumentDomain(
        name="fear_of_failure",
        description="Fear of task or project failure",
        keywords_en=["afraid to fail", "fail project", "lose job", "not finish", "low performance"],
        keywords_id=["takut gagal", "gagal project", "dipecat", "nggak selesai", "kinerja buruk"],
        weight=1.1,
    ),
    InstrumentDomain(
        name="thesis_stress",
    ...
    InstrumentDomain(
        ...
        description="Comparing work performance with peers",
        keywords_en=["everyone does better", "behind coworkers", "not good enough", "others succeed"],
        keywords_id=["orang lain lebih baik", "ketinggalan rekan kerja", "nggak mampu", "teman sukses"],
        weight=0.9,
    ),
    InstrumentDomain(
        name="future_anxiety",
        description="Anxiety about future career",
        keywords_en=["job security", "no future", "unemployed", "career anxiety", "what next"],
        keywords_id=["pekerjaan baru", "nggak ada masa depan", "pengangguran", "karir"],
        weight=1.0,
    ),
]
