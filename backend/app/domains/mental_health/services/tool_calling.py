...
from app.agents.health_ai.tools import execute_tool_call, get_health_ai_tools
...
async def generate_with_tools(
    ...
    Args:
        ...
        user_role: Optional caller role (user/counselor/admin) for tool policy
    ...
    tools = get_health_ai_tools(allowed_tool_names=tool_subset, user_role=user_role)
