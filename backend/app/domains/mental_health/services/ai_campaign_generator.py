...
**Target Audiences:**
- all_users: All active people
- high_risk: People with high/critical risk assessments
- inactive_users: People who haven't logged in recently
- recent_cases: People with active support cases
