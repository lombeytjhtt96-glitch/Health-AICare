...
class InsightsReportSchema(BaseModel):
    ...
    trending_topics: dict[str, Any] | list[dict[str, Any]] | None = None  # Can be dict or list depending on report type
    ...
    try:
        ...
        report_schemas = [
            InsightsReportSchema(  # type: ignore[call-arg]
                ...
                summary=r.summary,
                trending_topics=r.trending_topics if isinstance(r.trending_topics, dict) else {},
                sentiment_data=r.sentiment_data if isinstance(r.sentiment_data, dict) else {},
