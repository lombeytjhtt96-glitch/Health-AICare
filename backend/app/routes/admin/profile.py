...
async def get_admin_profile(
    ...
    # Ensure all profile fields are loaded to avoid lazy-loading in sync context
    await db.refresh(
        current_admin,
        ["email", "name", "first_name", "last_name", "phone", "allow_email_checkins", "created_at", "updated_at"]
    )
...
async def update_admin_profile(
    ...
    # Ensure all profile fields are loaded before processing updates
    await db.refresh(
        current_admin,
        ["email", "name", "first_name", "last_name", "phone", "allow_email_checkins", "created_at", "updated_at"]
    )
