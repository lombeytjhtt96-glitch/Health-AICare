    ...
    for user_obj, journal_count, conversation_count, badge_count, appointment_count in rows:
        ...
        users.append(
            UserListItem(
                ...
                sentiment_score=(user_obj.profile.sentiment_score if user_obj.profile else user_obj.sentiment_score) or 0.0,
                current_streak=(user_obj.profile.current_streak if user_obj.profile else user_obj.current_streak) or 0,
                longest_streak=(user_obj.profile.longest_streak if user_obj.profile else user_obj.longest_streak) or 0,
