...
from app.agents.health_ai.constants import (
    CRISIS_KEYWORDS,
    MAX_HISTORY_TURNS,
    SMALLTALK_HEALTH_AI_PREFIX,
    SMALLTALK_EXACT,
)
...
def is_smalltalk_message(text: str) -> bool:
    ...
    2. Length-bounded check against ``SMALLTALK_HEALTH_AI_PREFIX`` — O(1).
...
# ---------------------------------------------------------------------------
# Backward-compat private aliases (used in health_ai_orchestrator_graph)
# ---------------------------------------------------------------------------
