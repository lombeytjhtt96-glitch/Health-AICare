...
NATURAL_PROBES: List[NaturalProbe] = [
    ...
    NaturalProbe(
        ...
        context_triggers=[
            ...
            "mentions_no_friends", "life_life_discussion"
        ],
        probe_variations=[
            "Kalau di kehidupan, biasanya main sama siapa?",
    ...
    # =========================================================================
    # ACADEMIC (Study, career, or work-specific pressure)
    # =========================================================================
    NaturalProbe(
        dimension=ScreeningDimension.ACADEMIC,
        context_triggers=[
            "mentions_kerja", "mentions_tugas", "mentions_atasan",
            "work_period", "project_discussion", "performance_discussion"
        ],
        probe_variations=[
            "Gimana pekerjaan atau kesibukanmu akhir-akhir ini? Lancar?",
            "Lagi banyak kerjaan atau tugas harian nggak sekarang?",
            "Tanggung jawab atau target akhir-akhir ini gimana? Ada yang bikin pusing?",
            "Project atau pekerjaan pentingmu gimana progressnya?",
        ],
        follow_up_if_negative="Tekanan pekerjaan dan tugas harian emang real banget. Yang paling bikin overwhelmed apa?",
        information_goal="Understand work and daily task pressure level, identify specific stressors",
        priority=4,
    ),
...
def _select_contextual_probe(
    ...
    context_signals = {
        ...
        "academic_stress": any(w in message_lower for w in ["tugas", "kerja", "ujian", "project", "deadline"]),
