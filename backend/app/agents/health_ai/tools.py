...
_HEALTH_AI_ROLE_TOOL_ALLOWLISTS: Dict[str, Set[str]] = {
    "user": {
        "get_user_profile",
...
def get_health_ai_tools(
    ...
    try:
        ...
        role_allowlist = _HEALTH_AI_ROLE_TOOL_ALLOWLISTS.get(normalized_role, _HEALTH_AI_ROLE_TOOL_ALLOWLISTS["user"])
