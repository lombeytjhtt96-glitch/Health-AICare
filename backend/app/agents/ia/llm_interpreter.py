...
- Tidak ada informasi individual semua orang
...
1. RINGKASAN EKSEKUTIF (1 paragraf - Natural Language)
   ...
   - Contoh: "Sepanjang periode ini, sentimen semua orang menurun 12% yang didorong oleh lonjakan 'Stres Akademik'. Kasus risiko tinggi stabil, namun kebutuhan coaching meningkat."
