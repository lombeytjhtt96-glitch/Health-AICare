...
[
  {
    ...
    "priority": "high",
    "impact": "Reduce waiting time by ~40%, improve user satisfaction",
...
TUGAS KAMU:
1. Interpret data analytics dengan konteks kesehatan mental semua orang
2. Identify patterns, trends, dan anomalies yang signifikan
3. Kasih recommendations yang specific dan actionable untuk admin
4. Prioritas: user safety, service quality, resource optimization
```
