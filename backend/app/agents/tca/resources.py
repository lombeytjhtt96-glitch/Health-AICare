    ...
    catalog: dict[str, List[ResourceCard]] = {
        ...
        "acute_distress": [
            ResourceCard(
                ...
                url="https://health_aicare.example/distress/grounding-audio",
            ),
            ResourceCard(
                ...
                url="https://health_aicare.example/safety/plan-template",
            ),
        ],
        "relationship_strain": [
            ResourceCard(
                ...
                url="https://health_aicare.example/relationships/script",
            ),
            ResourceCard(
                ...
                url="https://health_aicare.example/support/warmline",
            ),
        ],
        "financial_pressure": [
            ResourceCard(
                ...
                url="https://health_aicare.example/finance/budget",
            ),
            ResourceCard(
                ...
                url="https://health_aicare.example/finance/checklist",
            ),
        ],
        "general_support": [
            ResourceCard(
                ...
                url="https://health_aicare.example/general/self-compassion",
            ),
            ResourceCard(
                ...
                url="https://health_aicare.example/general/counseling",
            ),
        ],
    }
