...
@register_tool(
    ...
    description="""Suggest optimal appointment times based on user preferences and counselor availability.
...
User can then choose one or request alternatives.""",
    parameters={
        ...
        "properties": {
            ...
            "preferences_text": {
                "type": "string",
                "description": "Natural language time preferences from user"
            }
        },
    ...
    **kwargs
    ...
    try:
        ...
        appointment = Appointment(
            user_id=user_id, # Fixed: user_id -> user_id
        ...
        result = await db.execute(
            ...
            .where(
                and_(
                    ...
                    Appointment.user_id == user_id # Fixed: user_id -> user_id
                )
            )
        )
...
async def get_user_appointments(
    ...
    **kwargs
    ...
    try:
        query = select(Appointment).where(Appointment.user_id == user_id) # Fixed: user_id -> user_id
