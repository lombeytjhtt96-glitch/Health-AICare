    ...
    class Config:
        json_schema_extra = {
            "example": {
                ...
                "conversation_summary": "User experiencing increasing academic stress with sleep deprivation over past week. Mentions feeling overwhelmed but has family support.",
                "user_context": {
