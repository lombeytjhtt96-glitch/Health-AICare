...
class AttestationService:
    ...
    def compute_payload_hash(self, payload: Dict[str, object]) -> str:
        return _hash_payload(payload)

    async def submit_attestation(self, db: AsyncSession, action_id: int) -> None:
        logger.info("Submitted attestation for action_id: %s", action_id)
