...
class Settings(BaseSettings):
    ...
    # Rate limits for people
    rate_limit_chat_per_minute_user: int = Field(10, alias="RATE_LIMIT_CHAT_PER_MINUTE_STUDENT")
    rate_limit_chat_per_hour_user: int = Field(100, alias="RATE_LIMIT_CHAT_PER_HOUR_STUDENT")
    rate_limit_chat_per_day_user: int = Field(500, alias="RATE_LIMIT_CHAT_PER_DAY_STUDENT")
    ...
    rate_limit_analytics_per_minute_user: int = Field(5, alias="RATE_LIMIT_ANALYTICS_PER_MINUTE_STUDENT")
    rate_limit_analytics_per_hour_user: int = Field(30, alias="RATE_LIMIT_ANALYTICS_PER_HOUR_STUDENT")
    rate_limit_analytics_per_day_user: int = Field(100, alias="RATE_LIMIT_ANALYTICS_PER_DAY_STUDENT")
