...
Features:
- Role-based rate limits (user, counsellor, admin)
...
class RateLimiter:
    ...
    async def check_rate_limit(
        ...
        Args:
            ...
            role: User role (user, counsellor, admin)
    ...
    def _get_limit_for_role(
        ...
        defaults = {
            "user": {"minute": 10, "hour": 100, "day": 500},
        ...
        return defaults.get(role, defaults["user"]).get(window, 100)
