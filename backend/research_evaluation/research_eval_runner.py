...
async def _call_health_ai_sse(
    ...
    *,
    ...
    """Call /api/v1/health_ai and parse metadata + final response (notebook-compatible)."""
    ...
    async with client.stream(
        "POST",
        f"{config.backend_url}/api/v1/health_ai",
        headers=headers,
        json=payload,
