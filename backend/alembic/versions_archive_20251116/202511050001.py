...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('user_id', sa.String(50), nullable=True, unique=True),  # NEW: NIM (unique constraint)
        ...
        sa.Index('idx_user_profiles_user_id', 'user_id'),
        sa.Index('idx_user_profiles_faculty_year', 'faculty', 'batch_year'),  # Common query: people by faculty & year
    )
    ...
    op.create_table(
        ...
        sa.Column('health_ai_personality', sa.String(20), nullable=False, default='empathetic'),  # NEW: empathetic, professional, casual
        sa.Column('health_ai_response_length', sa.String(20), nullable=False, default='balanced'),  # NEW: concise, balanced, detailed
