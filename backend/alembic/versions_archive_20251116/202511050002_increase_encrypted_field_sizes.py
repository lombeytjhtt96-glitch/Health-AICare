...
def upgrade():
    ...
    op.alter_column('user_profiles', 'user_id', type_=sa.String(200), existing_type=sa.String(50))
    ...
    op.alter_column('user_preferences', 'health_ai_personality', type_=sa.String(200), existing_type=sa.String(20))
    op.alter_column('user_preferences', 'health_ai_response_length', type_=sa.String(200), existing_type=sa.String(20))
...
def downgrade():
    ...
    op.alter_column('user_profiles', 'user_id', type_=sa.String(50), existing_type=sa.String(200))
    ...
    op.alter_column('user_preferences', 'health_ai_personality', type_=sa.String(20), existing_type=sa.String(200))
    op.alter_column('user_preferences', 'health_ai_response_length', type_=sa.String(20), existing_type=sa.String(200))
