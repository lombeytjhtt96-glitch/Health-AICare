...
def schema_upgrade() -> None:
    ...
    sa.Column('health_aicare_team_notes', sa.Text(), nullable=True, comment='Internal notes from HealthAICare team (not visible to user)'),
    ...
    sa.Column('email_newsletter', sa.Boolean(), nullable=True, comment='Subscribe to HealthAICare newsletter'),
    ...
    sa.Column('auto_suggest_interventions', sa.Boolean(), nullable=True, comment='HealthAI proactively suggests CBT interventions'),
    ...
    sa.Column('faculty', sa.String(length=200), nullable=True, comment="HealthAICare faculty (e.g., 'FMIPA', 'FEB', 'FK')"),
